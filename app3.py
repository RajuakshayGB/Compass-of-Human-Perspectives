...
- Dual-mode dynamic palette (Charcoal Slate-Grey / Warm Alabaster Off-White)
- 25-Dimension ambient tinted viewports
- Elevated interactive option tiles
- Dual-track execution (Quick 25 vs Full 100)
- Interactive 3D/Radar Vector Visualizer
- Multi-Channel Social Sharing & High-Definition PNG Passport Generator
"""
...
# ==============================================================================
# 2. STREAMLIT APPLICATION CONFIGURATION
# ==============================================================================
st.set_page_config(
...
# ==============================================================================
# 3. 25-DIMENSION CATEGORY AMBIENT TINT REGISTRY
# ==============================================================================
DIMENSION_TINTS = {
    0:  {"dark": "rgba(14, 165, 233, 0.08)", "light": "#EDF5FA"},   # Metaphysics & Reality
    1:  {"dark": "rgba(168, 85, 247, 0.08)", "light": "#F5EFFB"},   # Consciousness & Mind
    2:  {"dark": "rgba(20, 184, 166, 0.08)", "light": "#EDF8F6"},   # Epistemology & Knowledge
    3:  {"dark": "rgba(16, 185, 129, 0.08)", "light": "#ECF8F2"},   # Truth & Realism
    4:  {"dark": "rgba(217, 119, 6, 0.08)",  "light": "#FAF4E8"},   # Religion & Sacredness
    5:  {"dark": "rgba(124, 58, 237, 0.08)", "light": "#F3EEFA"},   # Death & Finitude
    6:  {"dark": "rgba(244, 63, 94, 0.08)",  "light": "#FCEEF0"},   # Purpose & Meaning
    7:  {"dark": "rgba(59, 130, 246, 0.08)", "light": "#EDF3FC"},   # Ethics & Meta-Ethics
    8:  {"dark": "rgba(6, 182, 212, 0.08)",  "light": "#EBF6F8"},   # Moral Action & Practical Virtue
    9:  {"dark": "rgba(234, 88, 12, 0.08)",  "light": "#FAF0EB"},   # Human Nature & Destiny
    10: {"dark": "rgba(139, 92, 246, 0.08)", "light": "#F2EEFA"},   # Self & Identity
    11: {"dark": "rgba(22, 163, 74, 0.08)",  "light": "#ECF6EE"},   # Free Will & Agency
    12: {"dark": "rgba(34, 197, 94, 0.08)",  "light": "#EFF7F1"},   # Society & Community
    13: {"dark": "rgba(29, 78, 216, 0.08)",  "light": "#EBF1FA"},   # Liberty & Governance
    14: {"dark": "rgba(146, 64, 14, 0.08)",  "light": "#F7F1EB"},   # Authority & Institutional Order
    15: {"dark": "rgba(225, 29, 72, 0.08)",  "light": "#FBEFF2"},   # Equality & Hierarchy
    16: {"dark": "rgba(101, 163, 13, 0.08)", "light": "#F2F7EB"},   # Economics & Distribution
    17: {"dark": "rgba(180, 83, 9, 0.08)",   "light": "#F8F1EA"},   # Culture & Tradition
    18: {"dark": "rgba(220, 38, 38, 0.08)",  "light": "#FCEFEF"},   # Political Change
    19: {"dark": "rgba(30, 58, 138, 0.08)",  "light": "#ECEFF7"},   # Global Scope & Loyalty
    20: {"dark": "rgba(16, 185, 129, 0.08)", "light": "#ECF8F3"},   # Ecology & Environment
    21: {"dark": "rgba(20, 184, 166, 0.08)", "light": "#EBF7F6"},   # Animal Ethics & Sentience
    22: {"dark": "rgba(124, 58, 237, 0.08)", "light": "#F3EEFA"},   # Technology & AI
    23: {"dark": "rgba(6, 182, 212, 0.08)",  "light": "#EBF6F8"},   # Civilizational Future
    24: {"dark": "rgba(249, 115, 22, 0.08)", "light": "#FAF1EB"}    # Pluralism & Openness
}

# ==============================================================================
# 4. BESPOKE GREY / OFF-WHITE CSS INJECTION
# ==============================================================================
def inject_custom_theme(theme: str = "Dark", dim_idx: int = 0):
    ...
    st.markdown(f"""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700;800&family=Inter:wght@400;500;600;700&family=Noto+Serif+Devanagari:wght@400;500;600;700&display=swap');
    ...
    div[data-testid="stButton"] > button:hover {{
        ...
        box-shadow: 0 8px 18px {palette['shadow']} !important;
    }}

    div[data-testid="stButton"] > button[kind="primary"] {{
        background-color: {palette['tile_selected_bg']} !important;
        border-color: {palette['tile_selected_border']} !important;
        box-shadow: 0 0 0 1px {palette['tile_selected_border']}, 0 8px 20px {palette['shadow']} !important;
    }}
    ...
    .tension-card {{
        ...
        box-shadow: 0 4px 14px {palette['shadow']} !important;
    }}
    ...
    .share-container {{
        ...
        padding: 24px;
        margin-top: 20px;
        box-shadow: 0 6px 18px {palette['shadow']};
    }}
    </style>
    """, unsafe_allow_html=True)

# ==============================================================================
# 5. LOCALIZED TEXT DICTIONARY
# ==============================================================================
UI_TEXT = {
    "English": {
        "title": "The Compass of Human Perspectives",
        "subtitle": "Why do you believe what you believe?",
        "tagline": "Embark on an intellectually serious, non-judgmental exploration of human thought. Across 25 or 100 questions, discover the structural architecture of your worldview and trace your affinities to major global traditions.",
        ...
        "map_title": "📊 3D Vector Space Mapping",
        "share_heading": "📢 Share Your Philosophical Profile",
        "share_sub": "Share your cognitive identity card or link directly with others:",
        "copy_link": "📋 Copy Direct Profile Link",
    ...
    "Hindi": {
        ...
        "map_title": "📊 3D वेक्टर स्पेस मैपिंग",
        "share_heading": "📢 अपनी दार्शनिक प्रोफ़ाइल साझा करें",
        "share_sub": "अपना डिजिटल पहचान पासपोर्ट या लिंक दूसरों के साथ साझा करें:",
        "copy_link": "📋 सीधा प्रोफ़ाइल लिंक कॉपी करें",
...
# ==============================================================================
# 6. HD PASSPORT & SHARING CARD ENGINE (PIL)
# ==============================================================================
def generate_hd_passport(user_coords, top_affinity, character_tags):
    ...
    draw.text((w // 2, 855), f"TRADITION LINEAGE: {thinkers_str}", fill=(160, 174, 192), anchor="mm")

    # Mock Pixelated Verification Barcode
...
# ==============================================================================
# 7. 3D & RADAR VISUALIZERS
# ==============================================================================
def render_3d_scatter(user_coords, worldviews_dict):
    """Renders interactive 3D scatter alignment comparing user and historical schools."""
    fig = go.Figure()
...
# ==============================================================================
# 8. STATE SYNCHRONIZATION & URL ENCODING
# ==============================================================================
def load_url_parameters():
    """Restores user session variables from URL query parameters if present."""
    try:
...
def generate_share_url():
    """Generates an encoded permalink representing the user's completed state."""
    encoded_answers = urllib.parse.quote(json.dumps(st.session_state.answers))
    base = "https://share.streamlit.io"
...
# Determine Active Category Dimension
...
if not st.session_state.started and not st.session_state.completed:
    ...
    with b1:
        ...
        if st.button(ui["start_quick"], use_container_width=True, type="primary"):
            ...
            st.rerun()
    with b2:
        st.info(f"**{ui['full_test']}**\n\n100 questions (4 per core dimension) for the complete comprehensive mirror.")
...
# ==============================================================================
# VIEW 2: QUESTION SLIDESHOW (TILED OPTIONS WITH CATEGORY AMBIENT TINT)
# ==============================================================================
...
# ==============================================================================
    ...
    li_url = f"https://www.linkedin.com/sharing/share-offsite/?url=https://compass-of-human-perspectives.streamlit.app"

    st.markdown(f"""
    <div style='display: flex; gap: 12px; margin-bottom: 20px; flex-wrap: wrap;'>
        <a href='{x_url}' target='_blank' style='text-decoration: none;'>
            <button style='padding: 10px 18px; border-radius: 8px; border: 1px solid #353D4A; background: #1A1E24; color: #E4E8EE; cursor: pointer;'>
                Share on X (Twitter) 🐦
            </button>
        </a>
        ...
        <a href='{li_url}' target='_blank' style='text-decoration: none;'>
            <button style='padding: 10px 18px; border-radius: 8px; border: 1px solid #353D4A; background: #1A1E24; color: #E4E8EE; cursor: pointer;'>
                Share on LinkedIn 💼
            </button>
        </a>
