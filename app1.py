...
# Ensure working directory is on Python search path
...
# ==============================================================================
# 1. 25-DIMENSION CATEGORY AMBIENT TINT PALETTES
# ==============================================================================
DIMENSION_TINTS = {
...
# ==============================================================================
# 2. INTEGRATED STYLE INJECTOR & CARD HELPERS
# ==============================================================================
def inject_premium_styles(theme: str = "Dark", dim_idx: int = 0):
    """
    Injects high-end CSS with Grey / Off-White palettes and category ambient tints.
    """
    ...
    if theme.lower() == "light":
        palette = {
            "bg_color": "#F7F5F0",          # Off-white / Warm Alabaster
            "text_color": "#1E293B",        # Deep slate
            "text_secondary": "#5A6A80",
            "text_hindi": "#57534E",
            "accent_color": "#9A722C",      # Academic bronze-gold
            "accent_hover": "#785621",
            "primary_btn_text": "#F7F5F0",
            "card_bg": "#FFFFFF",           # Clean solid white card
            "card_border": "#E2DCD2",
        ...
        palette = {
            "bg_color": "#1A1E24",          # Refined Charcoal / Slate-Grey
            "text_color": "#E4E8EE",        # Silver-white
            "text_secondary": "#A0AEC0",
            "text_hindi": "#94A3B8",
            "accent_color": "#D4AF37",      # Classic Gold
            "accent_hover": "#F3E5AB",
            "primary_btn_text": "#1A1E24",
            "card_bg": "#242932",           # Slate-grey tile card
            "card_border": "#353D4A",
            "card_hover_border": "#D4AF37",
            "card_checked_bg": "#2E3642",
            "card_checked_border": "#D4AF37",
    ...
    .cinzel-title {{
        ...
        line-height: 1.6;
        color: {palette['accent_color']} !important;
    }}
    ...
    /* Elevated Option Tile Transformation */
    ...
    div[data-testid="stButton"] > button:hover {{
        border-color: {palette['card_hover_border']} !important;
        transform: translateY(-2px) !important;
        box-shadow: 0 8px 18px {palette['shadow']} !important;
    }}

    div[data-testid="stButton"] > button[kind="primary"] {{
        background-color: {palette['card_checked_bg']} !important;
        border-color: {palette['card_checked_border']} !important;
        box-shadow: 0 0 0 1px {palette['card_checked_border']}, 0 8px 20px {palette['shadow']} !important;
    }}

    .tension-card {{
        padding: 22px 26px !important;
        background: {palette['card_bg']} !important;
        border-left: 4px solid {palette['accent_color']} !important;
...
def render_tension_card(title: str, description: str):
    """Renders cognitive tensions in an alert container."""
    st.markdown(f"""
    <div class='tension-card'>
        <div class='tension-title'>⚡ {title}</div>
        <div style='color: inherit; font-size: 0.95rem; line-height: 1.6;'>{description}</div>
    </div>
...
# ==============================================================================
# 4. PASSPORT GENERATOR & RADAR CHART
# ==============================================================================
...
inject_premium_styles(st.session_state.theme, active_dim_idx)
...
# ==============================================================================
    ...
    if tensions:
        for t in tensions:
            render_tension_card(t['title'], t['description'])
    else:
