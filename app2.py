...
Complete Presentation Layer with Integrated Homepage Dossier,
Glassmorphic Interaction Tiles, Metallic Outer Framing, Auto-Advance, and Session Recovery.
"""
...
# Ensure current working directory is on Python module search path
...
# ==============================================================================
# 1. IMPORTS FROM CORE DATA & ENGINE LAYERS
# ==============================================================================
...
# ==============================================================================
# 2. 25-DIMENSION AMBIENT TINT PALETTES
# ==============================================================================
DIMENSION_TINTS = {
...
# ==============================================================================
# 3. RESPONSIVE GLASSMORPHISM & METALLIC SHIMMER THEME
# ==============================================================================
def inject_custom_theme(theme: str = "Dark", dim_idx: int = 0):
    ...
    if theme.lower() == "light":
        palette = {
            ...
            "accent_gold": "#9A722C",
            "accent_silver": "#94A3B8",
            "glass_tile_bg": "rgba(255, 255, 255, 0.72)",
            "glass_tile_border": "rgba(154, 114, 44, 0.25)",
            "glass_tile_hover": "rgba(154, 114, 44, 0.65)",
            "glass_selected_bg": "rgba(154, 114, 44, 0.15)",
            "badge_bg": "#EFECE4",
            "badge_text": "#785B24",
            "border_outer": "#9A722C",
            "border_inner": "#CBD5E1",
            "shimmer": "rgba(255, 255, 255, 0.65)",
            "shadow": "0 8px 24px rgba(154, 114, 44, 0.08)"
        }
    else:
        palette = {
            "bg_base": "#0C1017",
            ...
            "accent_gold": "#D4AF37",
            "accent_silver": "#CBD5E1",
            "glass_tile_bg": "rgba(26, 32, 44, 0.65)",
            "glass_tile_border": "rgba(212, 175, 55, 0.22)",
            "glass_tile_hover": "rgba(212, 175, 55, 0.75)",
            "glass_selected_bg": "rgba(212, 175, 55, 0.18)",
            "badge_bg": "#151B24",
            "badge_text": "#D4AF37",
            "border_outer": "#D4AF37",
            "border_inner": "#64748B",
    ...
    /* Outer Double Border Framing (Gold & Silver Accents) */
    .stApp {{
        background-color: {palette['bg_base']} !important;
        background-image: radial-gradient(circle at 50% 10%, {active_tint} 0%, transparent 75%) !important;
    ...
    .entry-card:hover {{
        border-color: {palette['glass_tile_hover']};
        transform: translateY(-3px);
    }}

    /* Interactive Glass Tiles with Shimmer Glow */
    ...
    div[data-testid="stButton"] > button:focus-visible {{
        outline: 2px solid {palette['accent_gold']} !important;
    ...
    div[data-testid="stButton"] > button[kind="primary"] {{
        ...
        box-shadow: 0 0 0 1px {palette['accent_gold']}, 0 10px 25px rgba(0, 0, 0, 0.3) !important;
    }}
...
# ==============================================================================
# 4. LOCALIZED STRINGS & ARCHITECTURAL SUMMARY DATA
# ==============================================================================
UI_TEXT = {
    "English": {
        ...
        "quick_tag": "25 Questions • ~8 mins",
        "quick_desc": "Samples one representative question from each of the 25 foundational dimensions of human thought for an efficient diagnostic.",
        "full_title": "Full Odyssey",
        "full_tag": "100 Questions • ~25 mins",
        "full_desc": "A comprehensive assessment across all 100 questions (4 per dimension) providing the highest diagnostic fidelity and sub-dimension mapping.",
        "start_quick": "Launch Quick Odyssey ⚡",
        "start_full": "Launch Full Odyssey 🏛️",
    ...
    "Hindi": {
        ...
        "quick_tag": "25 प्रश्न • ~8 मिनट",
        "quick_desc": "त्वरित मूल्यांकन के लिए मानव विचार के 25 मूल आयामों में से प्रत्येक से एक प्रतिनिधि प्रश्न का उत्तर दें।",
        "full_title": "पूर्ण यात्रा",
        "full_tag": "100 प्रश्न • ~25 मिनट",
        "full_desc": "गहन विश्लेषण के लिए सभी 100 प्रश्नों (प्रत्येक आयाम से 4 प्रश्न) का समग्र और विस्तृत मूल्यांकन।",
        "start_quick": "त्वरित यात्रा शुरू करें ⚡",
        "start_full": "पूर्ण यात्रा शुरू करें 🏛️",
...
HOMEPAGE_SECTIONS = [
    {
        ...
        "desc_en": "Examines the fundamental fabric of reality, the mind-body problem, free will vs. determinism, and subjective consciousness.",
        "desc_hi": "वास्तविकता के मूल स्वरूप, मन-मस्तिष्क संबंध, स्वतंत्र इच्छा और चेतना का अन्वेषण करता है।"
    },
    {
        "icon": "⚖️",
        "title_en": "Ethics & Society",
        "title_hi": "नैतिकता और समाज",
        "desc_en": "Maps moral duties, virtue cultivation, community kinship (Ubuntu), and systemic governance models.",
        "desc_hi": "नैतिक कर्तव्यों, सद्गुण निर्माण, सामुदायिक रिश्तों और शासन प्रणालियों का विश्लेषण करता है।"
    },
    {
        "icon": "🌱",
        "title_en": "Ecology & Future",
        "title_hi": "पारिस्थितिकी और भविष्य",
        "desc_en": "Surveys biocentric environmental ethics, animal sentience, artificial intelligence, and transhuman horizons.",
        "desc_hi": "पर्यावरण नैतिकता, पशु अधिकार, कृत्रिम बुद्धिमत्ता और मानवोत्तर भविष्य का विश्लेषण करता है।"
    }
]

# ==============================================================================
# 5. EXPANDED HD IDENTIFIER DOSSIER GENERATOR (PIL)
# ==============================================================================
def generate_hd_passport(user_coords, top_affinity, character_tags, language="English"):
    ...
    # Double Border Framing: Gold Outer, Silver Inner
...
# ==============================================================================
# 7. STATE SYNCHRONIZATION & REFRESH RECOVERY ENGINE
# ==============================================================================
...
# ==============================================================================
# 8. TOP NAVIGATION BAR (HYPERLINKED BRAND LOGO)
# ==============================================================================
...
# ==============================================================================
# VIEW 1: LANDING HOMEPAGE (SUMMARIES + EXPANDERS + INTERACTIVE PORTAL TILES)
# ==============================================================================
if not st.session_state.started and not st.session_state.completed:
    ...
    for col, data in zip([s1, s2, s3], HOMEPAGE_SECTIONS):
        with col:
            ...
            st.markdown(f"""
            <div class='entry-card' style='height: 100%;'>
                <div style='font-size: 1.8rem; margin-bottom: 8px;'>{data['icon']}</div>
                <div style='font-weight: 700; font-size: 1.15rem; margin-bottom: 6px;'>{title}</div>
                <div style='font-size: 0.92rem; line-height: 1.5; color: inherit; opacity: 0.85;'>{desc}</div>
            </div>
            """, unsafe_allow_html=True)

    st.write("")

    # 2. Interactive Portal Entry Tiles
    b1, b2 = st.columns(2)
    with b1:
        st.markdown(f"""
        <div class='entry-card' style='border-top: 3px solid #D4AF37;'>
            <div style='display: flex; justify-content: space-between; align-items: center;'>
                <span style='font-weight: 700; font-size: 1.25rem;'>⚡ {ui['quick_title']}</span>
                <span class='category-badge' style='margin: 0;'>{ui['quick_tag']}</span>
            </div>
            <p style='margin-top: 10px; font-size: 0.95rem; line-height: 1.5; opacity: 0.9;'>{ui['quick_desc']}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with b2:
        st.markdown(f"""
        <div class='entry-card' style='border-top: 3px solid #38BDF8;'>
            <div style='display: flex; justify-content: space-between; align-items: center;'>
                <span style='font-weight: 700; font-size: 1.25rem;'>🏛️ {ui['full_title']}</span>
                <span class='category-badge' style='margin: 0;'>{ui['full_tag']}</span>
            </div>
            <p style='margin-top: 10px; font-size: 0.95rem; line-height: 1.5; opacity: 0.9;'>{ui['full_desc']}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    # 3. Collapsible Taxonomy Explorer
...
# ==============================================================================
# VIEW 2: QUESTIONNAIRE (INSTANT CLICK-TO-ADVANCE TILES & URL RECOVERY)
# ==============================================================================
...
# ==============================================================================
# VIEW 3: PROFILE REVEAL, DIAGNOSTICS & DOSSIER HUB
# ==============================================================================
    ...
    with r2:
        tab1, tab2 = st.tabs(["3D Vector Space", "Radar Comparison"])
        with tab1:
